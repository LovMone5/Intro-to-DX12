...
Bezier::Bezier(HINSTANCE hInstance): D3DApp(hInstance)
{
}

bool Bezier::Initialize()
{
...
void Bezier::Update(const GameTimer& gt)
{
	UpdateCamera(gt);
...
void Bezier::Draw(const GameTimer& gt)
{
...
void Bezier::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void Bezier::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void Bezier::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void Bezier::UpdateCamera(const GameTimer& gt)
{
...
void Bezier::UpdateObjectCBs(const GameTimer& gt)
{
...
void Bezier::UpdateMainPassCB(const GameTimer& gt)
{
...
void Bezier::UpdateMaterialCB(const GameTimer& gt)
{
...
void Bezier::UpdateAnimate(const GameTimer& gt)
{
}
...
void Bezier::BuildRenderItems()
{
	...
	quadRitem->PrimitiveType = D3D_PRIMITIVE_TOPOLOGY_16_CONTROL_POINT_PATCHLIST;
...
void Bezier::BuildShadersAndInputLayout()
{
	mVertexShader = d3dUtil::CompileShader(L"Shaders/Bezier.hlsl", "VS", "vs_5_0");
	mPixelShader = d3dUtil::CompileShader(L"Shaders/Bezier.hlsl", "PS", "ps_5_0"); 
	mHullShader = d3dUtil::CompileShader(L"Shaders/Bezier.hlsl", "HS", "hs_5_0");
	mDomainShader = d3dUtil::CompileShader(L"Shaders/Bezier.hlsl", "DS", "ds_5_0");
...
void Bezier::BuildFrameResource()
{
...
void Bezier::DrawRenderItems(const vector<RenderItem*>& ritems)
{
