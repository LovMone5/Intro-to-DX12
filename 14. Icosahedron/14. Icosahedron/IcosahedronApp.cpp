...
void IcosahedronApp::BuildRenderItems()
{
	...
	icosaRitem->PrimitiveType = D3D_PRIMITIVE_TOPOLOGY_3_CONTROL_POINT_PATCHLIST;
...
void IcosahedronApp::BuildShadersAndInputLayout()
{
	...
	mHullShader = d3dUtil::CompileShader(L"Shaders/SubDivide.hlsl", "HS", "hs_5_0");
	mDomainShader = d3dUtil::CompileShader(L"Shaders/SubDivide.hlsl", "DS", "ds_5_0");
